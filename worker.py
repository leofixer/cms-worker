...
# -------------------------
AIRTABLE_TOKEN = os.getenv("patkoV7zdZ1Gy5LC2.78f1d815b37edb2ee6bd493c81d5d77dd2248593cf0b00292452b2fb0aae4086")
AIRTABLE_BASE_ID = os.getenv("app0jVOid5GCmE65W")
AIRTABLE_TABLE = os.getenv("Content Beta V1")  # exact table name
OPENAI_API_KEY = os.getenv("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")
